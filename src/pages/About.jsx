...
export default function About() {
  return (
    <div id="about" className="container mx-auto py-32 relative">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        >
          ...
          <div className="absolute  -bottom-3 md:-bottom-5 right-0 md:-right-5 bg-[#7A211E] font-semibold text-xl text-white rounded-lg p-5">
            100% <br /> Youth-Led
          </div>
        </motion.div>
        ...
        >
          <h1 className="uppercase mx-10 mb-2 text-xl text-[#FF6B35]">
            Who we are
          </h1>
          <h2 className="font-bold text-4xl text-[#7A211E] mx-10 mb-4">
            About Us
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mx-2">
            <div className="w-full border-l-4 border-[#FF6B35] bg-[#f3efef3a] rounded-2xl p-4">
              <div className="flex gap-1 items-center mb-2">
                ...
                <h1 className="text-[#7A211E] font-bold text-xl">Mission</h1>
              </div>
              To inspire and empower young Africans to take bold steps toward
              personal growth, community transformation, and national
              development.
            </div>
            <div className="w-full border-l-4 rounded-2xl border-[#3d1ce4] bg-[#f3efef3a] p-4">
              <div>
