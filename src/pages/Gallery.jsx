          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 auto-rows-[200px]">
              <motion.div
                ...
                viewport={{ once: true }}
                className="md:col-span-2 md:row-span-2 rounded-3xl overflow-hidden group"
              >
                <img
                  alt="Gallery 1"
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="md:col-span-1 md:row-span-1 rounded-3xl overflow-hidden group"
              >
                <img
                  alt="Gallery 2"
                  className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="md:col-span-1 md:row-span-2 rounded-3xl overflow-hidden group"
              >
                <img
                  alt="Gallery 3"
                  className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
